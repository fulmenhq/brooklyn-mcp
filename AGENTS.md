...
## 🚨 MANDATORY READING FOR AI AGENTS (READ FIRST!)
...
- 🌉 Browser automation danger classification (Level 1-3)
- 🛡️ Mandatory safety protocols (6 core protocols)
...
- ✅ **Attribution Format**: Must follow Fulmen Spark attribution standards (see below)

## 🚀 Fulmen Spark Commit Attribution Standards
