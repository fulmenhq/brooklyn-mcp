...
**Status**: 🚧 In Progress (Auth Guard ready for merge)
---
...
- HTTP compatibility expansion (Kilocode streamable transport) pending Architect Brooklyn’s audit.
...
- [Feature Brief](../../../.plans/active/v0.3.0/brooklyn-http-auth-hardening-feature-brief.md)
