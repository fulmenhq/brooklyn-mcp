...
- HTTP compatibility expansion (streamable transport) validated for Claude Code, OpenCode, Kilocode, and Codex CLI.
- Full `bun run check-all` + release checklist execution prior to tagging/publishing.
