...
**❌ NEVER stage files that fail quality checks**
...
**❌ LIMITED PERMISSION to commit with unstaged files sitting in working directory**
...
- ✅ Fast tests: ~475 tests passed
- ✅ Full tests: ~799 tests passed, ~98 skipped
...
**⚠️ EXTREME CAUTION - Only use when repo is broken**
...
**💡 Alternative**: Consider using [Git Squash & Rebase SOP](git-squash-rebase-sop.md) to clean up commits before pushing instead of force-push
...
- ❌ No bypassing quality gates without documented emergency
- ❌ No committing failing code "to fix later"
...
**This SOP written by**: 🌉 Paris Brooklyn (MCP Platform Architect)  
...
_"Bridge capabilities with precision, not recklessness"_ - 🌉 Paris Brooklyn
